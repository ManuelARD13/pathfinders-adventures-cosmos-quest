            ...
            <table className="statsTable">
                    <tbody>    
                        ...
                        <tr>
                            ...
                            <td><span id="CONTotal" className="totalScores">{raze !== "" ? characterStats.CON + raze.razeModifiers.CON : characterStats.CON }</span></td>
                        </tr>
                        <tr>
                            <td>STR</td>
                            ...
                            <td><span id="STRTotal" className="totalScores">{raze !== "" ? characterStats.STR + raze.razeModifiers.STR : characterStats.STR }</span></td>
                        </tr>
                        <tr>
                            <td>DEX</td>
                            ...
                            <td><span id="DEXTotal" className="totalScores">{raze !== "" ? characterStats.DEX + raze.razeModifiers.DEX : characterStats.DEX }</span></td>
                        </tr>
                        <tr>
                            <td>INT</td>
                            ...
                            <td><span id="INTTotal" className="totalScores">{raze !== "" ? characterStats.INT + raze.razeModifiers.INT : characterStats.INT }</span></td>
                        </tr>
                        <tr>
                            <td>WIS</td>
                            ...
                            <td><span id="WISTotal" className="totalScores">{raze !== "" ? characterStats.WIS + raze.razeModifiers.WIS : characterStats.WIS }</span></td>
                        </tr>
                        <tr>
                            <td>CHA</td>
                            ...
                            <td><span id="CHATotal" className="totalScores">{raze !== "" ? characterStats.CHA + raze.razeModifiers.CHA : characterStats.CHA }</span></td>
                        </tr>
                    </tbody>
                </table>
        </div>
